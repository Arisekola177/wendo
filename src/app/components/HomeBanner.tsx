...
const HomeBanner = () => {
  return (
    <div className="bg-[#073528] w-full h-screen md:h-[80vh] xl:h-screen relative">
      <div className="md:w-10/12 w-full mx-auto grid xs:grid-cols-1 md:grid-cols-2 h-full items-center justify-center gap-4">
        ...
        <div className="bg-[#AEE9A4] h-full relative xs:py-32 md:py-0">
          ...
          <div className="flex items-center xs:gap-4 sm:gap-8 md:gap-12 lgl:gap-16 xl:gap-12 absolute xs:top-3 sm:top-0 md:top-20 xl:top-32 left-0 right-0 justify-center">
            <div className="w-6 xs:h-12  sm:w-8 sm:h-20 xs:mt-16 sm:mt-32  lgl:mt-44 rounded-3xl bg-[#073528]" />
            <div className=" w-6 xs:h-12  sm:w-8  sm:h-20 rounded-3xl bg-[#073528]" />
            <div className=" w-6  xs:h-12  sm:w-8  sm:h-20 rounded-3xl bg-[#073528]" />
            <div className="w-6  xs:h-12  sm:w-8  sm:h-20   rounded-3xl bg-[#073528]" />
            <div className=" w-6  xs:h-12  sm:w-8  sm:h-20 sm:mt-32 xs:mt-16  lgl:mt-44 rounded-3xl bg-[#073528]" />
          </div>
          ...
          <div className='hidden md:block absolute md:bottom-64 lgl:bottom-96 xl:bottom-56 md:-right-12 lgl:-right-16 xl:right-24 md:w-[70px] md:h-[80px] lg:w-[115px] lg:h-[125px] bg-white rounded-2xl'>
          ...
          <div className='md:hidden absolute mt-20 xs:right-6 sm:right-16 sml:right-32 bg-white w-16 h-20 rounded-2xl'>
          ...
          <div className='md:w-[370px] xs:w-[250px]  mx-auto bg-white rounded-3xl flex items-center justify-center p-1 xl:p-2 absolute left-0 right-0 xs:bottom-8 sm:bottom-12 md:bottom-12 lgl:bottom-32 xl:bottom-24 '>
